...
const Doctor = () => {
  ...
  const getAllDoctors = async () => {
    try {
      const response = await axios.get(
        "https://doc-back-7r9w.onrender.com/api/v1/admin/getAllDoctors",
        {
          headers: {
  ...
  const handleRejectAccount = async (record) => {
    try {
      const res = await axios.post(
        "https://doc-back-7r9w.onrender.com/api/v1/admin/rejectAccountStatus",
  ...
  const handleAccountStatus = async (record, status) => {
    try {
      const res = await axios.post(
        "https://doc-back-7r9w.onrender.com/api/v1/admin/changeAccountStatus",
