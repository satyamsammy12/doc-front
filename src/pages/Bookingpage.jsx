...
const Bookingpage = () => {
  ...
  const getUserData = async () => {
    try {
      const response = await axios.post(
        "https://doc-back-7r9w.onrender.com/api/v1/doctor/getDoctorById",
  ...
  const handleBooking = async () => {
    try {
      ...
      const res = await axios.post(
        "https://doc-back-7r9w.onrender.com/api/v1/user/book-appointment",
        {
          doctorId: params.doctorId,
          userId: user._id,
          doctorInfo: data,
  ...
  const handleAvailability = async () => {
    try {
      ...
      const res = await axios.post(
        "https://doc-back-7r9w.onrender.com/api/v1/user/booking-availability",
